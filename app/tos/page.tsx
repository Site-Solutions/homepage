    ...
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white shadow">
        <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl font-bold text-gray-900">Privacy Policy for BuildSimpli</h1>
        </div>
      </header>
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="bg-white shadow overflow-hidden sm:rounded-lg">
          <div className="px-4 py-5 sm:p-6">
            ...
            <p className="mb-4">We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Free Privacy Policy Generator</a>.</p>
            ...
            <ul className="list-disc pl-5 mb-4 space-y-2">
              ...
              <li><strong>Application</strong> refers to BuildSimpli, the software program provided by the Company.</li>
              <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to BuildSimpli.</li>
            ...
            <h4 className="text-lg font-medium mt-4 mb-2">Business Transactions</h4>
            ...
            <h4 className="text-lg font-medium mt-4 mb-2">Law enforcement</h4>
            ...
            <h4 className="text-lg font-medium mt-4 mb-2">Other legal requirements</h4>
            ...
            <ul className="list-disc pl-5 mb-4">
              <li>By email: carterjsherman@gmail.com</li>
            </ul>

            <p className="mt-8 text-sm text-gray-500">Generated using <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator/" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">Free Privacy Policy Generator</a></p>
          </div>
        </div>
      </main>
