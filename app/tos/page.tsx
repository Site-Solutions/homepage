export const metadata = {
    title: "Terms of Service | BuildSimpli",
    description: "Terms of Service for BuildSimpli - Read our terms and conditions.",
}

export default function TermsOfService() {
    return (
        <main className="container mx-auto px-4 py-12 max-w-4xl">
            <h1 className="text-3xl font-bold mb-6">Privacy Policy for BuildSimpli</h1>

            <h2 className="text-2xl font-bold mb-4">Privacy Policy</h2>
            <p className="text-sm text-gray-600 mb-6">Last updated: October 31, 2024</p>
            ...
            <div className="prose prose-slate max-w-none">
                ...
                <ul className="list-disc pl-6 space-y-2">
                    ...
                    <li>
                        <strong>Application</strong> refers to BuildSimpli, the software program provided by the Company.
                    </li>
                    <li>
                ...
                <h3 className="text-xl font-medium mt-6 mb-3">Business Transactions</h3>
                <p>
                ...
                <h3 className="text-xl font-medium mt-6 mb-3">Law enforcement</h3>
                <p>
                ...
                <h3 className="text-xl font-medium mt-6 mb-3">Other legal requirements</h3>
                ...
                <p className="text-sm text-gray-500 mt-4">Generated using Free Privacy Policy Generator</p>
            </div>
        </main>
    )
}
